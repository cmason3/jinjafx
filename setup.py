...
install_requires = ["jinja2>=3.0", "pytz", "pyyaml", "cryptography>=2.7", "netaddr", "lxml", "func_timeout"]

if sys.version_info[0] == 3 and sys.version_info[1] == 6:
  install_requires = ["jinja2>=3.0,<3.1", "pytz", "pyyaml", "cryptography>=2.7,<37.0", "netaddr", "lxml", "func_timeout"]
